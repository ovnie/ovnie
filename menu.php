...
if(isset($_SESSION['id']) AND isset($_SESSION['pseudo']) AND isset($_SESSION['mail'])){
	...
	echo '<p class="textCenter"><a href="https://ovnie.com/profil.php">Profil</a>/<a href="https://ovnie.com/deconnexion.php">Déconnexion</a></p>';
}
else{
?>
	...
	<p class="textCenter"><a href="https://ovnie.com/inscription.php">Inscription</a></p>
<?php
}
?>
...
{
?>
	<li><a href="https://ovnie.com/categories.php?rubrique=<?php echo $recup_categories['id']; ?>" title="Ovnie - <?php echo htmlspecialchars($recup_categories['titre']); ?>" ><?php echo htmlspecialchars($recup_categories['titre']); ?></a></li>
<?php
...
<p class="textCenter"><a href="https://ovnie.com/share.php">&#x2192; Partage de liens</a></p>
<h1><strong>Accès réservé</strong></h1>
<ul>
	<li><a href="https://ovnie.com/admin/message.php" title="Ovnie - News" >Les tickets</a></li>
	<li><a href="https://ovnie.com/admin/layout.php" title="Ovnie - Articles" >Les articles</a></li>
	<li><a href="https://ovnie.com/admin/membres.php" title="Ovnie - Membres" >Les membres</a></li>
</ul>
<p class="textCenter"><a href="https://ovnie.com/notauthorized.php">&#x2192; Not Authorized</a></p>