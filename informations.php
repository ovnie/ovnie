	...
	<body>
		...
		<section>
			...
			<article>
				...
				<p class="textJustify">Ovnie est une organisation à but non lucratif créée en 2020 par un groupe d'individus ayant pour objectif de développer un réseau unique d'échange d'informations sur des sujets à caractère sérieux/mystérieux.</p>
